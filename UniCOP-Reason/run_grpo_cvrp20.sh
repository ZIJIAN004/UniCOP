...
# 基座模型: SFT 产物按 BASE_MODEL_TYPE 切换
#   r1_distill     → output_sft_hybrid_cvrp20/final_model      (DeepSeek-R1-Distill-Qwen-7B + SFT)
#   qwen3_thinking → output_sft_qwen3_template_cvrp20/final_model (Qwen3-4B-Thinking + SFT)
